...
class ConflictDetectorTest {
    ...
    fun `getConflicts with different pages should return no conflicts`() {
        ...
        val remoteModelMutations = listOf(
            RemoteModelMutation<SyncBookmark>(
                model = PageBookmark(id = "remote-1", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(1000)),
                remoteID = "remote-1",
        ...
        val localModelMutations = listOf(
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local-1", page = 20, isReading = false, lastModified = Instant.fromEpochMilliseconds(1001)),
                remoteID = null,
                localID = "local-1",
                mutation = Mutation.CREATED
            )
    ...
    fun `getConflicts with creation events for same page should detect conflict`() {
        ...
        val remoteModelMutations = listOf(
            ...
            RemoteModelMutation<SyncBookmark>(
                model = PageBookmark(id = "remote-2", page = 20, isReading = false, lastModified = Instant.fromEpochMilliseconds(1001)),
                remoteID = "remote-2",
                mutation = Mutation.CREATED
            )
        )
        val localModelMutations = listOf(
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local-1", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(1003)),
                remoteID = null,
                localID = "local-1",
                mutation = Mutation.CREATED
            ),
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local-2", page = 40, isReading = false, lastModified = Instant.fromEpochMilliseconds(1004)),
                remoteID = null,
                localID = "local-2",
                mutation = Mutation.CREATED
            )
    ...
    fun `getConflicts with multiple remote mutations for same page should group them together`() {
        ...
        val remoteModelMutations = listOf(
            ...
            RemoteModelMutation<SyncBookmark>(
                model = PageBookmark(id = "remote-2", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(1001)),
                remoteID = "remote-2",
                mutation = Mutation.CREATED
            ),
            RemoteModelMutation<SyncBookmark>(
                model = PageBookmark(id = "remote-3", page = 20, isReading = false, lastModified = Instant.fromEpochMilliseconds(1002)),
                remoteID = "remote-3",
                mutation = Mutation.CREATED
            )
        )
        val localModelMutations = listOf(
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local-1", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(200)),
                remoteID = null,
                localID = "local-1",
                mutation = Mutation.CREATED
            )
    ...
    fun `getConflicts with delete and create events on both sides for same page should detect conflict`() {
        ...
        val localModelMutations = listOf(
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "remote-1", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(1003)),
                remoteID = "remote-1",
                localID = "local-1",
                mutation = Mutation.DELETED
            ),
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local-2", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(1004)),
                remoteID = null,
                localID = "local-2",
                mutation = Mutation.CREATED
            ),
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local-3", page = 30, isReading = false, lastModified = Instant.fromEpochMilliseconds(1005)),
                remoteID = null,
                localID = "local-3",
                mutation = Mutation.CREATED
            )
    ...
    fun `getConflicts with multiple local mutations for same page should group them together`() {
        ...
        val localModelMutations = listOf(
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local-1", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(1002)),
                remoteID = "remote-1",
                localID = "local-1",
                mutation = Mutation.DELETED
            ),
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local-2", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(1003)),
                remoteID = null,
                localID = "local-2",
                mutation = Mutation.CREATED
            ),
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local-3", page = 30, isReading = false, lastModified = Instant.fromEpochMilliseconds(1004)),
                remoteID = null,
                localID = "local-3",
                mutation = Mutation.CREATED
            )
    ...
    fun `getConflicts with matching remote IDs should detect conflict even with zeroed model properties`() {
        ...
        val remoteModelMutations = listOf(
            RemoteModelMutation<SyncBookmark>(
                model = PageBookmark(id = "remote-1", page = 0, isReading = false, lastModified = Instant.fromEpochMilliseconds(0)), // Zeroed properties for DELETE
                remoteID = "remote-1",
                mutation = Mutation.DELETED
            ),
            RemoteModelMutation<SyncBookmark>(
        ...
        val localModelMutations = listOf(
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local-1", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(1002)), // Original page info for local DELETE
                remoteID = "remote-1", // Same remote ID as remote mutation
                localID = "local-1",
                mutation = Mutation.DELETED
            ),
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local-2", page = 30, isReading = false, lastModified = Instant.fromEpochMilliseconds(1002)),
                remoteID = null,
                localID = "local-2",
                mutation = Mutation.CREATED
            )
