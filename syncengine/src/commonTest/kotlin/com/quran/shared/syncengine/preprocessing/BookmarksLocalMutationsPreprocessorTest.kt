...
class BookmarksLocalMutationsPreprocessorTest {
    ...
    fun `should return two mutations for same page unchanged`() {
        ...
        assertTrue(exception.message?.contains("Bookmark sura=1, ayah=1 has 2 creations") == true)
    ...
    fun `should throw error when more than two mutations for same page`() {
        ...
        assertTrue(exception.message?.contains("Bookmark sura=1, ayah=1 has 4 mutations") == true) // After conversion, there are 4 mutations
    ...
    fun `should handle multiple pages with valid mutation counts`() {
        ...
        assertTrue(exception.message?.contains("Bookmark sura=1, ayah=1 has 2 creations") == true ||
                  exception.message?.contains("Bookmark sura=3, ayah=1 has 2 creations") == true)
    }
    ...
    fun `should throw error when any page has more than two mutations`() {
        ...
        assertTrue(exception.message?.contains("Bookmark sura=1, ayah=1 has 4 mutations") == true)
        assertTrue(exception.message?.contains("exceeds logical limit of 2") == true)
    }
    ...
    fun `should handle mutations for different pages independently when all are valid`() {
        ...
        assertTrue(exception.message?.contains("Bookmark sura=1, ayah=1 has 2 creations") == true ||
                  exception.message?.contains("Bookmark sura=2, ayah=1 has 2 creations") == true)
    }
    ...
    fun `should throw error when there are two deletions for same page`() {
        ...
        assertTrue(exception.message?.contains("Bookmark sura=1, ayah=1 has 2 deletions") == true)
        assertTrue(exception.message?.contains("which is not allowed") == true)
    }
