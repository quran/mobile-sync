...
class ConflictDetectorTest {
    ...
    fun `getConflicts with matching remote IDs should detect conflict even with zeroed model properties`() {
        ...
        val remoteModelMutations = listOf(
            RemoteModelMutation(
                model = PageBookmark(id = "remote-1", page = 0, lastModified = 0L), // Zeroed properties for DELETE
                remoteID = "remote-1",
                mutation = Mutation.DELETED
            ),
            RemoteModelMutation(
        ...
        val localModelMutations = listOf(
            LocalModelMutation(
                model = PageBookmark(id = "local-1", page = 10, lastModified = 1002L), // Original page info for local DELETE
                remoteID = "remote-1", // Same remote ID as remote mutation
                localID = "local-1",
                mutation = Mutation.DELETED
            ),
            LocalModelMutation(
                model = PageBookmark(id = "local-2", page = 30, lastModified = 1002L),
                remoteID = null,
                localID = "local-2",
                mutation = Mutation.CREATED
            )
        ...
        assertEquals(1002L, localMutation.model.lastModified, "Last modified of local mutation")
        assertEquals(0, remoteMutation.model.page, "Page number of remote mutation")
        assertEquals(0, remoteMutation.model.lastModified, "Last modified of remote mutation")
