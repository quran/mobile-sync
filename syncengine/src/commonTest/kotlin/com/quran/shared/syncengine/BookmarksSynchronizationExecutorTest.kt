...
class BookmarksSynchronizationExecutorTest {
    
    private val pipeline = BookmarksSynchronizationExecutor()
    ...
    fun `test successful synchronization with no conflicts`() = runTest {
        ...
        val remoteMutations = listOf(
            RemoteModelMutation<SyncBookmark>(
                model = PageBookmark(id = "remote1", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(1000)),
                remoteID = "remote1",
                mutation = Mutation.CREATED
            ),
            RemoteModelMutation<SyncBookmark>(
                model = PageBookmark(id = "remote2", page = 20, isReading = false, lastModified = Instant.fromEpochMilliseconds(1001)),
                remoteID = "remote2",
                mutation = Mutation.MODIFIED
            ),
            RemoteModelMutation<SyncBookmark>(
                model = PageBookmark(id = "remote3", page = 30, isReading = false, lastModified = Instant.fromEpochMilliseconds(1002)),
                remoteID = "remote3",
        ...
        val localMutations = listOf(
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local1", page = 15, isReading = false, lastModified = Instant.fromEpochMilliseconds(1002)),
                remoteID = null,
                localID = "local1",
                mutation = Mutation.CREATED
            ),
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local2", page = 25, isReading = false, lastModified = Instant.fromEpochMilliseconds(1003)),
                remoteID = "remote2",
                localID = "local2",
                mutation = Mutation.MODIFIED
            )
        ...
        val result = pipeline.executePipeline(
            fetchLocal = {
                BookmarksSynchronizationExecutor.PipelineInitData(lastModificationDate, localMutations)
            },
            fetchRemote = { _ ->
                BookmarksSynchronizationExecutor.FetchedRemoteData(remoteMutations, updatedModificationDate)
            },
            ...
            pushLocal = { _, _ ->
                ...
                BookmarksSynchronizationExecutor.PushResultData(emptyList(), updatedModificationDate)
            }
        )
    ...
    fun `test multiple conflicts detection`() = runTest {
        ...
        val localMutations = listOf(
            ...
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local1", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(1003)),
                remoteID = null,
                localID = "local1",
                mutation = Mutation.CREATED
            ),
            ...
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local2", page = 20, isReading = false, lastModified = Instant.fromEpochMilliseconds(1004)),
                remoteID = null,
                localID = "local2",
                mutation = Mutation.MODIFIED
            ),
            ...
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local3", page = 30, isReading = false, lastModified = Instant.fromEpochMilliseconds(1005)),
                remoteID = "remote3",
                localID = "local3",
                mutation = Mutation.DELETED
            ),
            // No conflict
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local4", page = 40, isReading = false, lastModified = Instant.fromEpochMilliseconds(1006)),
                remoteID = null,
                localID = "local4",
                mutation = Mutation.CREATED
            )
    ...
    fun `test illogical scenario - too many mutations for same page`() = runTest {
        val localMutations = listOf(
            ...
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local1", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(1000)),
                remoteID = null,
                localID = "local1",
                mutation = Mutation.CREATED
            ),
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local2", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(1001)),
                remoteID = null,
                localID = "local2",
                mutation = Mutation.CREATED
            ),
            LocalModelMutation<SyncBookmark>(
                model = PageBookmark(id = "local3", page = 10, isReading = false, lastModified = Instant.fromEpochMilliseconds(1002)),
                remoteID = "remote1",
                localID = "local3",
                mutation = Mutation.DELETED
            )
        ...
        val exception = assertFailsWith<IllegalArgumentException> {
            pipeline.executePipeline(
                ...
                fetchRemote = { _ ->
                    BookmarksSynchronizationExecutor.FetchedRemoteData(emptyList(), updatedModificationDate)
                },
                checkLocalExistence = { remoteIDs ->
                    remoteIDs.associateWith { true }
                },
        ...
        assertEquals(
            exception.message?.contains("Illogical scenario detected"),
            true,
            "Error message should include illogical scenario details"
        )
        assertEquals(
            exception.message?.contains("Bookmark sura=10, ayah=1 has 3 mutations"),
            true,
    ...
    fun `test illogical scenario - deletion without remote ID`() = runTest {
        ...
        assertEquals(
            exception.message?.contains("deletion without remote ID"),
            true,
    ...
    fun `test pipeline filters out DELETE mutations for non-existent resources`() = runTest {
        ...
        val localMutations = emptyList<LocalModelMutation<SyncBookmark>>()
        val lastModificationDate = 500L
        val updatedModificationDate = 1500L
